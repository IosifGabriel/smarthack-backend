...
//	}
	...
	@PutMapping(value="/editDocumentBlob/{documentId}")
	public ResponseEntity<?> editDocumentBlob(@PathVariable("documentId") Integer id, @RequestParam byte[] stream) {
		try {
			Document document = documentService.getItem(id);
			document.setDocumentBlob(stream);
